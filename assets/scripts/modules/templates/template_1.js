 ...
 */export async function templateOne(){
	const template = `<div id='templateOne' class='template-one relative'>
		<div class='relative content-block display-flex'>
			...
			<hr/>
			<header class='relative'><h2>Licenses from The Space Mall.</h2></header>
			<article class='relative'>
				<p>These are now for sale and can be paid with dollars, euros or cryptos.</p>
				<p>With a license in this first pre-launch phase you will now receive TSM tokens and CPC coins.</p>
				<p class='ltr-arrow relative'>Participate, find out more?</p>
				<p>You can email me via the link below and I will be happy to help you.</p>
				<p>Your Sponsor is Aad Pouw(from the Netherlands).</p>
			</article>
			<hr/>
