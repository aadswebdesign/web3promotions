...
export const content_nl = async ()=>{
	return `
		<article class='home-page relative'>
			...
			<h3>Allereerst wil ik mij graag even voorstellen.</h3>
			<p class='fl-one'>Ik ben een gepensioneerde die het leuk vindt om ergens mee bezig te zijn in plaats van alleen maar oud te worden.</p>
			<h3>Dan, waarom deze website?</h3>
			<p class='fl-one'>Omdat mijn pensioen beperkt is, zocht ik naar een manier om daar iets aan te doen.
